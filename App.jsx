...
import SmartChickenCareProdScr from './App/screens/SmartChickenCareProdScr';
...
const App = () => {
  ...
  const INITIAL_URL = `https://breathtaking-venerable-gratification.space/`;
  const URL_IDENTIFAIRE = `32P5qZVM`;
  ...
  OneSignal.initialize('7ef819cb-a3a1-4beb-bcc6-82477b697a60');
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="SmartChickenCareProdScr"
                                    component={SmartChickenCareProdScr}
            ...
            <MusicProvider>
                  <NavigationContainer>
                        {!louderIsEnded || !aceptTransperency || !completeLink ? (
                              ...
                              <Animated.Image
                                    source={require('./App/sourceAssets/appLoaders/chickenLoader1.png')}
                                    style={{
                                          //...props.style,
                              ...
                              />
                              <Animated.Image
                                    source={require('./App/sourceAssets/appLoaders/chickenLoader2.png')}
                                    style={{
                                          //...props.style,
